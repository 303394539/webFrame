module.exports = function(grunt) {
  ...
  grunt.initConfig({
    ...
    uglify: {
      ...
      //   }, {
      //     expand: true,
      //     src: ["**/*.js", "!js/frame.js", "!node_modules/**", "!*.js", "!bower_components/**", "!egret-working/**"],
      //     dest: "build/"
      //   }, ]
      // },
      proc: {
        ...
        files: [{
          ...
          expand: true,
          src: ["**/*.js", "!js/**", "!dist/**/*-debug.js", "!*.js", "!node_modules/**", "!bower_components/**", "!egret-working/**"],
          dest: "build/"
        }]
      }
    },
    ...
    stylus: {
      build: {
        files: [{
          src: ["**/*.styl", "!node_modules/**", "!bower_components/**", "!egret-working/**"],
          ext: ".css",
          expand: true
        }]
      }
    ...
    cssmin: {
      ...
      build: {
        files: [{
          expand: true,
          src: ["**/*.css", "!css/*.css", "css/main.css", "!node_modules/**", "!bower_components/**", "!egret-working/**"],
          dest: "build/"
        }]
      }
    },
